...
readlineSync.question('Hello ' + name +', Welcome to DOOM! Where you will risk your life to fight evil. Press Enter to Rip and Tear.');

const badGuys = ['Zombie', 'Imp', 'Cacodemon', 'Lost Soul', 'Hellknight', 'Baron of Hell', 'Cyber Demon'];
const treasure = ['Medkit', 'Armor Plating', 'Beserk', 'Haste', 'Ammo', 'Health Position'];
var prize = [];
let userHealth = 40;
